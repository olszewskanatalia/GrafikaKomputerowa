...
class Scene(object):
    ...
    def load_scene(self):
        scene = []
        scene.append(Cube((-10, -10, 30), 10, 'orange'))
        scene.append(Cube((10, -10, 40), 10, 'green'))
        scene.append(Cube((10, -10, 60), 20, 'white'))
        scene.append(Cube((-10, -20, 70), 5, 'yellow'))
    ...
    def render(self):
        ...
        for cube in self.scene_data:
            for edge in cube:
                if edge[0][2] > self.start_point[2] and edge[1][2] > self.start_point[2]:
