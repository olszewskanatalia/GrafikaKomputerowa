...
class SoftwareRender:
    ...
    def create_objects(self):
        ...
        vertexes_blue = array([
            (0, 0, 20, 1), (0, 1, 20, 1), (1, 1, 20, 1), (1, 0, 20, 1),
            (0, 0, 21, 1), (0, 1, 21, 1), (1, 1, 21, 1), (1, 0, 21, 1)
        ])
        vertexes_red = array([
            (0, 1.5, 20, 1), (0, 2.5, 20, 1), (1, 2.5, 20, 1), (1, 1.5, 20, 1),
            (0, 1.5, 21, 1), (0, 2.5, 21, 1), (1, 2.5, 21, 1), (1, 1.5, 21, 1)
        ])
        vertexes_green = array([
            (1.5, 1.5, 20, 1), (1.5, 2.5, 20, 1), (2.5, 2.5, 20, 1), (2.5, 1.5, 20, 1),
            (1.5, 1.5, 21, 1), (1.5, 2.5, 21, 1), (2.5, 2.5, 21, 1), (2.5, 1.5, 21, 1)
        ])
        vertexes_yellow = array([
            (1.5, 0, 20, 1), (1.5, 1, 20, 1), (2.5, 1, 20, 1), (2.5, 0, 20, 1),
            (1.5, 0, 21, 1), (1.5, 1, 21, 1), (2.5, 1, 21, 1), (2.5, 0, 21, 1)
        ])

        vertexes_orange = array([
            (0, 0, 21.5, 1), (0, 1, 21.5, 1), (1, 1, 21.5, 1), (1, 0, 21.5, 1),
            (0, 0, 22.5, 1), (0, 1, 22.5, 1), (1, 1, 22.5, 1), (1, 0, 22.5, 1)
        ])

        vertexes_pink = array([
            (0, 1.5, 21.5, 1), (0, 2.5, 21.5, 1), (1, 2.5, 21.5, 1), (1, 1.5, 21.5, 1),
            (0, 1.5, 22.5, 1), (0, 2.5, 22.5, 1), (1, 2.5, 22.5, 1), (1, 1.5, 22.5, 1)
        ])
        vertexes_brown = array([
            (1.5, 1.5, 21.5, 1), (1.5, 2.5, 21.5, 1), (2.5, 2.5, 21.5, 1), (2.5, 1.5, 21.5, 1),
            (1.5, 1.5, 22.5, 1), (1.5, 2.5, 22.5, 1), (2.5, 2.5, 22.5, 1), (2.5, 1.5, 22.5, 1)
        ])
        vertexes_violet = array([
            (1.5, 0, 21.5, 1), (1.5, 1, 21.5, 1), (2.5, 1, 21.5, 1), (2.5, 0, 21.5, 1),
            (1.5, 0, 22.5, 1), (1.5, 1, 22.5, 1), (2.5, 1, 22.5, 1), (2.5, 0, 22.5, 1)
        ])
